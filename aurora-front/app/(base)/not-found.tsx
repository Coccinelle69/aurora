...
export default function NotFoundPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center px-6">
      ...
      <main className="relative z-10 text-center bg-marineBlue/55 p-12 xl:p-16 2xl:p-20 rounded-4xl mt-40 lg:mt-0">
        <h1
...
"
        ...
        <h2 className={`text-2xl xl:text-4xl font-heading mb-4 text-white`}>
          {t("notFound")}
        </h2>
        <button
          onClick={() => router.back()}
