...
export default function Contact() {
  return (
    <section className="relative overflow-hidden bg-white py-24">
      <div className="absolute right-0 top-28 h-[1100px] md:h-[1000px] xl:h-[950px]  w-[62vw] bg-[#D3DAE0]" />

      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between">
          <div className="order-2 lg:order-1 flex justify-center lg:block mt-9 lg:mt-0">
            <div className="relative xl:left-25  h-[600px] lg:h-[650px] w-[400px] font-body bg-[#234361] overflow-hidden p-12 shadow-[0_35px_35px_rgba(0,0,0,0.20)] ">
